...
def load_fold_results() -> dict[str, dict[int, dict]]:
    """Load test_results.json for each config × fold.
...
def main():
    ...
    parser.add_argument("--output", type=str, default=str(RESULTS_DIR / "kfold_analysis.json"))
    parser.add_argument("--plot", type=str, default=str(RESULTS_DIR / "kfold_analysis.png"))
    ...
    plot_analysis(analysis, Path(args.plot))
